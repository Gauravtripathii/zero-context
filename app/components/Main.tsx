  ...
  return (
    <div className="h-5/6 px-5 sm:px-10 lg:px-14 xl:px-24 py-5">
      {!isLoggedIn || userMessage ? (
        ...
        <div onClick={() => setOpenMessagePopUp(true)}>
          <TextCard
            message="+"
      ...
      {openMessagePopUp ? (
        <div className="popup bg-white border border-black rounded-md w-3/4 md:w-1/2 h-fit pb-5 md:pt-5 md:px-5 relative ml-2 mt-2">
          <div
          ...
          <div className="p-5">
            ...
            />
            <button className="mt-5 px-3 py-2 outline-none w-full border border-black rounded-xl font-bold text-white bg-black hover:text-black hover:bg-white md:text-xl" onClick={addMessage}>
              SUBMIT
            </button>
          </div>
        </div>
